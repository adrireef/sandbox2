...
//	if ($('#sliderDistance').val() != '10') {
    ...
    function modalPop(e) {
		...
		var SearchableMapLib.selectedPoint=[e.target.feature.geometry.coordinates[1], e.target.feature.geometry.coordinates[0]];
        SearchableMapLib.selectedPoint.setStyle({ icon: (new L.Icon({
