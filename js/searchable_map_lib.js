...
var SearchableMapLib = {
  ...
  function printDiv() {
	...
	newWin.document.write('<html><body><pre style="overflow: auto; white-space:nowrap; width:100%; background:white; line-height:0.5cm; text-align:justify; font-family:calibri,arial,sans-serif; padding:0 20px;">'+divToPrint.innerHTML+'</pre></body></html>');
