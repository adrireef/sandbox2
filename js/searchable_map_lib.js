...
var SearchableMapLib = {
  ...
  function printDiv() {
	...
	newWin.document.write('<html><body onload="window.print()"><pre style="width:100%; overflow:auto; background:white; line-height:0.5cm; text-align:justify; font-family:calibri,arial,sans-serif; padding:0 20px;">'+divToPrint.innerHTML+'</pre></body></html>');
